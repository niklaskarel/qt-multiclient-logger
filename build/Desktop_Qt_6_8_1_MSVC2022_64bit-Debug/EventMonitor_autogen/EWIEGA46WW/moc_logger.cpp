...
void Logger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->messageReady((*reinterpret_cast< std::add_pointer_t<EventMessage>>(_a[1]))); break;
        case 1: _t->flushBuffer(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Logger::*)(const EventMessage & );
            if (_q_method_type _q_method = &Logger::messageReady; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Logger::messageReady(const EventMessage & _t1)
{
